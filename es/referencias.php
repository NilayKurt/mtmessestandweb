...
$navbar = render_navbar('es', 'references');
$footer = render_footer('es', 1, 'references');
...
foreach ($refs as $ref) {
    ...
    $alt = htmlspecialchars($ref['alt_es'] ?? $ref['alt'] ?? 'MT Messe Stand exhibition stand reference');
...
// Pagination
if (empty($cards)) {
    $cards = '<div class="col-12 text-center py-5"><p class="text-muted">Nuestra galería de referencias está en preparación.</p></div>';
}
...
$schema = [
    ...
    '@graph' => [
        [
            ...
            'url' => 'https://mtmessestand.com/es/references/',
            'inLanguage' => 'en',
        ...
        [
            ...
            'itemListElement' => [
                ...
                ['@type' => 'ListItem', 'position' => 2, 'name' => 'References', 'item' => 'https://mtmessestand.com/es/references/'],
            ],
        ],
    ],
];
...
<head>
  ...
  <title>Referencias — Portfolio de Stands | MT Messe Stand</title>
  <meta name="description" content="Portfolio de stands MT Messe Stand — más de 300 stands de madera y modulares Maxima en 28+ países. — 300+ custom wooden, Maxima modular, and country pavilion stands built for clients across 28+ countries. Real projects, real results.">
  <meta name="author" content="MT Messe Stand">
  <meta name="robots" content="index, follow">
  <link rel="canonical" href="https://mtmessestand.com/es/references/">
  <link rel="alternate" hreflang="x-default" href="https://mtmessestand.com/es/references/">
  <link rel="alternate" hreflang="en" href="https://mtmessestand.com/es/references/">
  <link rel="alternate" hreflang="tr" href="https://mtmessestand.com/tr/referanslar/">
  <link rel="icon" type="image/png" href="../assets/img/favicon.png">
  <link rel="apple-touch-icon" href="../assets/img/favicon.png">

  <meta property="og:title" content="Referencias — Portfolio de Stands | MT Messe Stand">
  <meta property="og:description" content="Portfolio de stands MT Messe Stand — más de 300 stands de madera y modulares Maxima en 28+ países.">
  <?php if ($ogImage): ?>
  <meta property="og:image" content="<?= $ogImage ?>">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <?php endif; ?>
  <meta property="og:url" content="https://mtmessestand.com/es/references/">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="MT Messe Stand">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Referencias — Portfolio de Stands | MT Messe Stand">
  <meta name="twitter:description" content="Portfolio de stands MT Messe Stand — más de 300 stands de madera y modulares Maxima en 28+ países.">
  <?php if ($ogImage): ?>
...
<section class="section">
  <div class="container">
    <div class="section-title" data-aos="fade-up">
      <h1>Nuestro Portfolio de Stands</h1>
      <p class="lead">Cada stand cuenta una historia de colaboración y artesanía.</p>
    </div>

    <div class="row mb-5" data-aos="fade-up">
      <div class="col-lg-6">
        <h2>Stands Que Abren Mercados</h2>
        <p>Desde 2010, MT Messe Stand ha construido más de 300 stands personalizados en 28+ países.</p>
      </div>
      <div class="col-lg-6">
        <h2>Clientes Satisfechos, Alianzas Fuertes</h2>
        <p>Nuestros clientes vuelven cada año — precios asequibles, instalación puntual, soporte WhatsApp.</p>
      </div>
    </div>
