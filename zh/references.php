...
$navbar = render_navbar('zh', 'references');
$footer = render_footer('zh', 1, 'references');
...
foreach ($refs as $ref) {
    ...
    $alt = htmlspecialchars($ref['alt_zh'] ?? $ref['alt'] ?? 'MT Messe Stand exhibition stand reference');
...
// Pagination
if (empty($cards)) {
    $cards = '<div class="col-12 text-center py-5"><p class="text-muted">参考画廊正在准备中。</p></div>';
}
...
$schema = [
    ...
    '@graph' => [
        [
            ...
            'url' => 'https://mtmessestand.com/zh/references/',
            'inLanguage' => 'en',
        ...
        [
            ...
            'itemListElement' => [
                ...
                ['@type' => 'ListItem', 'position' => 2, 'name' => 'References', 'item' => 'https://mtmessestand.com/zh/references/'],
            ],
        ],
    ],
];
...
<head>
  ...
  <title>参考案例 — 展台作品集 | MT Messe Stand</title>
  <meta name="description" content="MT Messe Stand 展台作品集 — 在28+个国家建造的300多个定制木质和Maxima模块化展台。 — 300+ custom wooden, Maxima modular, and country pavilion stands built for clients across 28+ countries. Real projects, real results.">
  <meta name="author" content="MT Messe Stand">
  <meta name="robots" content="index, follow">
  <link rel="canonical" href="https://mtmessestand.com/zh/references/">
  <link rel="alternate" hreflang="x-default" href="https://mtmessestand.com/zh/references/">
  <link rel="alternate" hreflang="en" href="https://mtmessestand.com/zh/references/">
  <link rel="alternate" hreflang="tr" href="https://mtmessestand.com/tr/referanslar/">
  <link rel="icon" type="image/png" href="../assets/img/favicon.png">
  <link rel="apple-touch-icon" href="../assets/img/favicon.png">

  <meta property="og:title" content="参考案例 — 展台作品集 | MT Messe Stand">
  <meta property="og:description" content="MT Messe Stand 展台作品集 — 在28+个国家建造的300多个定制木质和Maxima模块化展台。">
  <?php if ($ogImage): ?>
  <meta property="og:image" content="<?= $ogImage ?>">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <?php endif; ?>
  <meta property="og:url" content="https://mtmessestand.com/zh/references/">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="MT Messe Stand">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="参考案例 — 展台作品集 | MT Messe Stand">
  <meta name="twitter:description" content="MT Messe Stand 展台作品集 — 在28+个国家建造的300多个定制木质和Maxima模块化展台。">
  <?php if ($ogImage): ?>
...
<section class="section">
  <div class="container">
    <div class="section-title" data-aos="fade-up">
      <h1>展台作品集</h1>
      <p class="lead">每个展台都讲述着合作、工艺和市场进入的故事。</p>
    </div>

    <div class="row mb-5" data-aos="fade-up">
      <div class="col-lg-6">
        <h2>打开市场的展台</h2>
        <p>自2010年以来，MT Messe Stand 在28+个国家建造了300多个定制展台。</p>
      </div>
      <div class="col-lg-6">
        <h2>满意的客户，强大的合作伙伴</h2>
        <p>我们的客户每年都会回来 — 实惠的价格、准时安装、WhatsApp支持。</p>
      </div>
    </div>
