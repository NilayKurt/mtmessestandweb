...
$navbar = render_navbar('fr', 'references');
$footer = render_footer('fr', 1, 'references');
...
foreach ($refs as $ref) {
    ...
    $alt = htmlspecialchars($ref['alt_fr'] ?? $ref['alt'] ?? 'MT Messe Stand exhibition stand reference');
...
// Pagination
if (empty($cards)) {
    $cards = '<div class="col-12 text-center py-5"><p class="text-muted">Notre galerie de références est en préparation.</p></div>';
}
...
$schema = [
    ...
    '@graph' => [
        [
            ...
            'url' => 'https://mtmessestand.com/fr/references/',
            'inLanguage' => 'en',
        ...
        [
            ...
            'itemListElement' => [
                ...
                ['@type' => 'ListItem', 'position' => 2, 'name' => 'References', 'item' => 'https://mtmessestand.com/fr/references/'],
            ],
        ],
    ],
];
...
<head>
  ...
  <title>Références — Portfolio Stands | MT Messe Stand</title>
  <meta name="description" content="Portfolio de stands MT Messe Stand — plus de 300 stands en bois et modulaires Maxima dans 28+ pays. — 300+ custom wooden, Maxima modular, and country pavilion stands built for clients across 28+ countries. Real projects, real results.">
  <meta name="author" content="MT Messe Stand">
  <meta name="robots" content="index, follow">
  <link rel="canonical" href="https://mtmessestand.com/fr/references/">
  <link rel="alternate" hreflang="x-default" href="https://mtmessestand.com/fr/references/">
  <link rel="alternate" hreflang="en" href="https://mtmessestand.com/fr/references/">
  <link rel="alternate" hreflang="tr" href="https://mtmessestand.com/tr/referanslar/">
  <link rel="icon" type="image/png" href="../assets/img/favicon.png">
  <link rel="apple-touch-icon" href="../assets/img/favicon.png">

  <meta property="og:title" content="Références — Portfolio Stands | MT Messe Stand">
  <meta property="og:description" content="Portfolio de stands MT Messe Stand — plus de 300 stands en bois et modulaires Maxima dans 28+ pays.">
  <?php if ($ogImage): ?>
  <meta property="og:image" content="<?= $ogImage ?>">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <?php endif; ?>
  <meta property="og:url" content="https://mtmessestand.com/fr/references/">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="MT Messe Stand">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Références — Portfolio Stands | MT Messe Stand">
  <meta name="twitter:description" content="Portfolio de stands MT Messe Stand — plus de 300 stands en bois et modulaires Maxima dans 28+ pays.">
  <?php if ($ogImage): ?>
...
<section class="section">
  <div class="container">
    <div class="section-title" data-aos="fade-up">
      <h1>Notre Portfolio de Stands</h1>
      <p class="lead">Chaque stand raconte une histoire de partenariat et de savoir-faire.</p>
    </div>

    <div class="row mb-5" data-aos="fade-up">
      <div class="col-lg-6">
        <h2>Des Stands Qui Ouvrent des Marchés</h2>
        <p>Depuis 2010, MT Messe Stand a livré plus de 300 stands personnalisés dans 28+ pays.</p>
      </div>
      <div class="col-lg-6">
        <h2>Clients Satisfaits, Partenariats Solides</h2>
        <p>Nos clients reviennent chaque année — prix abordables, installation à temps, support WhatsApp.</p>
      </div>
    </div>
